...
#Use a SELECT statement to ensure higher rated items are in stock.
SELECT item_name, stock_quantity, average_rating FROM superstore ORDER BY average_rating desc;

#Use a SELECT statement to discover if a specific item is well-stocked. 
SELECT stock_quantity FROM superstore WHERE item_name = "Premium Coffee Maker";
